...
class Media {
  ...
  createTitle() {
    // Title creation disabled - labels removed
  ...
  onResize({ screen, viewport }: { screen?: ScreenSize; viewport?: Viewport } = {}) {
    ...
    // Adjust scale based on screen size - larger images on mobile for better visibility
    const isMobile = this.screen.width < 640;
    const baseScale = isMobile ? this.screen.height / 1200 : this.screen.height / 1500;
    this.scale = baseScale;
    
    // Adjust dimensions - make images larger on mobile
    const heightMultiplier = isMobile ? 1000 : 900;
    const widthMultiplier = isMobile ? 800 : 700;
